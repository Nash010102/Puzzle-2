...
const ITEMS = {
  ...
  locked_desk: {
    ...
    clueText: 'Three-digit lock. Clue 1 is in this diary (digit 2 = 7, digit 3 = 3). Find digit 1 elsewhere.',
    puzzle: 'desk_lock',
    symbol: false
  },
  wall_clock: {
    ...
    inspectText: `A grandfather clock, ornate and immense. It has stopped.\n\nThe hands point to 11:04 PM.\n\nThe face of the clock has a small brass plaque at the base:\n"The time of truth is always 11:04."\n\nInside the clock's case, wedged between the pendulum weights, is a folded note:\n\n"First dial: Adrian was born in the fourth month. Count backwards from October."\n\nThat's the clue you needed. The first digit of the desk lock.\n\nApril is the 4th month. Count backwards from October (month 10): 10 - 4 = 6.\nBut wait — the note says "count backwards from October," meaning start at October and step back 4 months: October → September → August → July → June.\nJune = 6.\n\nFirst digit: 6.`,
    clueText: 'Desk lock — First digit: 6 (clock cipher — born in April, counted back from October)',
  ...
  recipe_book: {
    ...
    clueText: 'Recipe book aconitine note: dated Dec 8 — but murder was Nov 15. Handwriting not Emma\'s.',
  ...
  fingerprint_kit: {
    ...
    clueText: 'Bottle neck: Noah\'s prints (works in kitchen). Bottle base: Emma\'s prints — INSIDE GLOVE OUTLINE. Deliberately planted.',
  ...
  servants_log: {
    ...
    clueText: 'Emma has a 65-minute gap between gallery close (21:30) and her return (22:47). Distance: 12 min.',
  ...
  hidden_safe: {
    ...
    clueText: 'Four-digit safe — combination is "the year" from the assembled voice recording.',
    puzzle: 'safe_unlock',
    symbol: false
  },
  wardrobe_mirror: {
  ...
  cctv_fragments: {
    ...
    clueText: 'CCTV clips show: Lucas left at 19:30 via front gate. No clip places him indoors after that.',
  ...
  timeline_board: {
    ...
    clueText: 'Timeline proves: Emma re-entered manor at 23:00 via staff gate using her personal code. Murder at 23:04.',
  ...
  lab_journal: {
    ...
    clueText: 'Admin code changed to 7734. Wire config: R→3, B→1, G→5, Y→2, W→4. Shadow log has original timestamps.',
    puzzle: null,
    symbol: false
  },
  basement_hint_terminal: {
  ...
  access_logs: {
    ...
    clueText: 'Access log: EC-ADMIN (Emma) altered CCTV timestamp on Nov 14. Used staff gate override at 23:00 on Nov 15.',
    puzzle: null,
    symbol: false
  },
  override_terminal: {
    ...
    clueText: 'Admin code: found in lab journal. Unlocks the shadow log — which has unaltered timestamps.',
  ...
  cctv_master: {
    ...
    clueText: 'CCTV shadow log shows: Emma re-entered at 23:00 (not 22:46 as stated). Clip 6 timestamp was faked.',
  ...
  admin_panel: {
    ...
    clueText: 'Encrypted file decoded: Emma held a £4.2M account payable upon Adrian\'s death. Financial motive confirmed.',
    puzzle: 'hex_decode',
    symbol: false
  },
  detective_board_item: {
...
const PUZZLES = {
  ...
  diary_cipher: {
    ...
    type: 'code_entry',
    digits: 3,
    prompt: 'The diary contains a smeared 3-digit code fragment: ?-7-3.\nThe wall clock reveals: "First dial: born in the fourth month, count backwards from October."\nOctober minus 4 steps back = June = 6.\nEnter the three-digit desk code.',
    answer: '673',
  ...
  desk_lock: {
    ...
    type: 'code_entry',
    digits: 3,
    prompt: 'The desk requires a 3-digit combination.\nDigit 1: From the stopped clock cipher (born in April, count backwards from October) = 6\nDigit 2: From the diary inside cover = 7\nDigit 3: From the diary inside cover = 3\n\nEnter the combination:',
    answer: '673',
  ...
  wire_connect: {
    ...
    type: 'wire',
    prompt: 'From Adrian\'s lab journal:\n"Wire configuration: Red→3, Blue→1, Green→5, Yellow→2, White→4"\n\nConnect each colored wire to the correct numbered terminal.',
    wires: [
  ...
  hint_study_cipher: {
    ...
    type: 'cipher',
    isHintPuzzle: true,
    prompt: 'The terminal claims the shift is "the square root of the number of books on the shelf."\n\nBut look again: the shelf has 36 books. Square root of 36 = 6.\n\nHowever, a faded sticker at the bottom of the terminal reads: "Always subtract 3 from the shift value."\n\nSo: 6 - 3 = 3. Shift = 3.\n\nEncrypted message:\nKDV HPPDV DOLEL XPDHV WDEOLV KHG\n\nDecrypt with shift 3 (shift each letter back by 3):\nK→H, D→A, V→S, etc.\n\nEnter the decoded phrase:',
...
Emma had detailed knowledge of the manor's security systems. She used that knowledge to plan and execute the murder, then immediately began destroying evidence.`
  ...
  hint_security_combined: {
    ...
    isText: true,
    isHintPuzzle: true,
    prompt: 'This terminal requires answers from all four previous hint challenges.\n\nFormat: first letter of Study answer + first letter of Kitchen answer + Magic Square center number + decoded Binary name\n\nStudy cipher decoded to: "HAS EMMAS ALIBI BEEN ESTABLISHED" → first letter: H\nKitchen logic answer (Emma\'s location): "GALLERY" → first letter: G\nMagic square center cell: 5\nBinary decoded name: EMMA\n\nCombined code: H-G-5-EMMA\n\nEnter the combined code (no dashes, no spaces):',
    answer: 'HG5EMMA',
